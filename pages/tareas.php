...
<div class="form-group" style="max-width:280px;margin-bottom:16px">
    ...
    <select onchange="ajaxFiltro('/pages/tareas.php?estado=<?= urlencode($filtroEstado) ?>&empleado='+this.value)">
...
<div class="tareas-filters">
    <a href="/pages/tareas.php?empleado=<?= $filtroEmpleado ?>" class="filter-btn <?= !$filtroEstado?'active':'' ?>" onclick="return ajaxFiltro(this.href)">Todas (<?= array_sum($contMap) ?>)</a>
    ...
    <a href="/pages/tareas.php?estado=<?= urlencode($k) ?>&empleado=<?= $filtroEmpleado ?>" class="filter-btn <?= $filtroEstado===$k?'active':'' ?>" onclick="return ajaxFiltro(this.href)"><?= $label ?> (<?= $contMap[$k]??0 ?>)</a>
    <?php endforeach; ?>
</div>
...
<div class="card">
    ...
    <tr>
        <td style="max-width:220px"><strong class="text-clip" title="<?= e($t['nombre_tarea']) ?>" style="max-width:220px"><?= e($t['nombre_tarea']) ?></strong><?php if($t['descripcion']): ?><br><small class="text-muted text-clip" title="<?= e($t['descripcion']) ?>" style="max-width:220px"><?= e(mb_substr($t['descripcion'],0,60)) ?><?= strlen($t['descripcion'])>60?'…':'' ?></small><?php endif; ?></td>
        ...
        <td class="text-secondary" style="font-size:13px"><?php if($t['asignado_nombre']): ?><div style="display:flex;align-items:center;gap:6px;min-width:0"><?= avatarChip($t['asignado_foto'],$t['asignado_nombre'],22) ?> <span class="text-clip" title="<?= e($t['asignado_nombre']) ?>" style="max-width:140px"><?= e($t['asignado_nombre']) ?></span></div><?php else: ?>—<?php endif; ?></td>
